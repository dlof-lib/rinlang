...
global.history = { pushState: (s, t, u) => { pushed.push(u); if (u && u[0] === '?') location.search = u; } };
...
(async () => {
  ...
  eq(t.parseQuery('?library=math'), { library: 'math', package: null, publisher: null, view: null }, 'parse ?library=');
