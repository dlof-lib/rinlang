// tools/test_indsin_sizing.cpp — tests for Rin Indsin's Constraint System (§5/§6): sizing=
// (fit/hug/fill/expand/fixed/auto) and min_width/max_width/min_height/max_height.
//
// Build (from app/src/main/cpp):
//   g++ -std=c++17 -I. -Iindsin ../../../../tools/test_indsin_sizing.cpp rin_lexer.cpp rin_parser.cpp \
//       diagnostics/diagnostic.cpp diagnostics/diagnostic_engine.cpp \
//       diagnostics/diagnostic_renderer.cpp diagnostics/source_manager.cpp -o test_indsin_sizing
