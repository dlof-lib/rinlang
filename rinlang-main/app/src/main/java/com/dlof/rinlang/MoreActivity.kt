...
import com.dlof.rinlang.store.projects.RinProjectsGalleryActivity
...
class MoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 3.6 معرض مشاريع Rin
        findViewById<View>(R.id.rowProjectGallery).setOnClickListener {
            startActivity(Intent(this, RinProjectsGalleryActivity::class.java))
        }
