...
data class RinPackage(
    ...
    /**
     * أيقونة الحزمة (اختيارية): صورة مربّعة صغيرة مرمَّزة base64، تُصغَّر ويُعرَض منها دائرة
     * مقصوصة عبر [AvatarUtils.decodeCircularAvatar] بدل شارة الحرف الأول الافتراضية، في بطاقة
     * المتجر وصفحة تفاصيل الحزمة. فارغة يعني: لم يرفع الناشر أيقونة، فتُستخدَم الشارة الافتراضية.
     */
