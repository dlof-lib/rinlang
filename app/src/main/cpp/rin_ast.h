...
// جسم Program (RinError أو throw صريح) لا يُعاد رميه بعد الآن، بل يُلتَقط هنا ويُنفَّذ جسم
// recover بدلاً منه، فيستمر البرنامج بعده بشكل طبيعي (تماماً كأن @Program كانت كتلة try/catch
