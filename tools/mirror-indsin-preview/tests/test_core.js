...
@view.Column=root
  ...
  @view.Card=header
    ...
    @view.Text=subtitle text="Indsintime rendering engine"; size=14; .end/view
  .end/view
  @view.Row=actions
    gap=12;
...
console.log('PASS: numeric attribute (padding=16, unquoted) correctly honored by the Indsin.');

// --- Test 2: source edit -> Shuttle diff ---
const SRC_EDITED = SRC_V1.replace('Indsintime rendering engine', 'Indsintime rendering engine v2');
